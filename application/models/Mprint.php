...
class Mprint extends CI_Model
{
    ...
    {
        $sql = 'SELECT barang.idbarang, barang.nama_barang, barang.harga_beli_pcs, barang.harga_jual_pcs, jual.id_barang, jual.date_penjualan, jual.st_jual, beli.id_barang, beli.date_pembelian, beli.st_beli FROM barang
